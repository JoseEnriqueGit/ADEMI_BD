...
|---|---|---|---|---|---|
| 1 | `PR_V_ENVIO_REPRESTAMOS` | PR | VIEW | Origen del incidente; alimenta el envío de représtamos (SMS/email/campañas). Reescrita varias veces. | **pendiente** (placeholder creado) |
| 2 | `PR_PKG_REPRESTAMOS` | PR | PACKAGE | Paquete de más tráfico; tiene CHANGELOG propio y múltiples optimizaciones (OPT-0xx). Atomicidad spec+body. | pendiente |
