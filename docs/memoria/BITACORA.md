...
- **Pendientes:** Incremento C y capa DIAGNOSTICA (propuestas separadas). No se ejecuto Oracle desde el repo (todo en Toad por el usuario); nada se promovio a PROD; `body copy.sql` intacto.
