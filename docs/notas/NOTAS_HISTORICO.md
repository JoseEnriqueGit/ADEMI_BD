qué tal si te ofrezco la tabla de estados para identificar los estados que tiene que ver con los Preaprobados 



también te voy a dar el paquete para que identifique cuales son los estados relacionados a los preaprobados de represtamos:
