CREATE OR REPLACE FUNCTION PA.obt_telefono_persona(inCodPersona     IN  NUMBER,
        ...
        BEGIN
            SELECT DECODE (l.cod_area, NULL, l.num_telefono,
             ...
             WHERE l.cod_per_fisica = inCodPersona
               AND l.cod_laboral = (select max(x.cod_laboral ) from info_laboral x where x.cod_per_fisica = l.cod_per_fisica  ) ;
        EXCEPTION
