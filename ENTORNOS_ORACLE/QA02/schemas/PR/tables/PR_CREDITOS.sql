DROP TABLE PR.PR_CREDITOS CASCADE CONSTRAINTS;

CREATE TABLE PR.PR_CREDITOS
(
  CODIGO_EMPRESA                  NUMBER(4),
  NO_CREDITO                      NUMBER(7),
  CODIGO_AGENCIA                  NUMBER(5) CONSTRAINT NN_PR_CREDITOS_CODAGENCIA NOT NULL,
  CODIGO_MONEDA                   NUMBER(2) CONSTRAINT NN_PR_CREDITOS_CODMONEDA NOT NULL,
  CODIGO_CLIENTE                  NUMBER(7) CONSTRAINT NN_PR_CREDITOS_CODCLIENTE NOT NULL,
  CODIGO_DIRECCION                NUMBER(8),
  TIPO_CREDITO                    NUMBER(3) CONSTRAINT NN_PR_CREDITOS_TIPCREDITO NOT NULL,
  ESTADO                          VARCHAR2(2 BYTE) CONSTRAINT NN_PR_CREDITOS_ESTADO NOT NULL,
  MONTO_CREDITO                   NUMBER(16,2) CONSTRAINT NN_PR_CREDITOS_MTOCREDITO NOT NULL,
  ES_LINEA_CREDITO                VARCHAR2(1 BYTE) CONSTRAINT NN_PR_CREDITOS_ESLINEACREDITO NOT NULL,
  TIPO_LINEA                      VARCHAR2(1 BYTE),
  MANEJO                          NUMBER(1),
  MODALIDAD_COBRO                 VARCHAR2(1 BYTE) CONSTRAINT NN_PR_CREDITOS_MODALICOBRO NOT NULL,
  TIPO_INTERESES                  VARCHAR2(1 BYTE) CONSTRAINT NN_PR_CREDITOS_TIPINTERESES NOT NULL,
  TIPO_CALENDARIO                 NUMBER(1) CONSTRAINT NN_PR_CREDITOS_TIPCALENDARIO NOT NULL,
  TIPO_CUOTA                      VARCHAR2(1 BYTE),
  CODIGO_PERIODO_CUOTA            VARCHAR2(2 BYTE) NOT NULL,
  CODIGO_PERIODO_INTERESES        VARCHAR2(2 BYTE),
  PERIODO_COMISION_NORMAL         VARCHAR2(2 BYTE),
  COMISION_NORMAL                 NUMBER(10,4),
  CUOTA                           NUMBER(16,2) CONSTRAINT NN_PR_CREDITOS_CUOTA NOT NULL,
  ...
  PLAZO                           NUMBER(5) CONSTRAINT NN_PR_CREDITOS_PLAZO NOT NULL,
  ID_SISTEMA_EXTERNO              VARCHAR2(15 BYTE),
  NO_SOLICITUD                    NUMBER(7),
  NO_CREDITO_ORIGEN               NUMBER(7),
  TIPO_TASA                       VARCHAR2(1 BYTE) CONSTRAINT NN_PR_CREDITOS_TIPTASA NOT NULL,
  CODIGO_TIPO_DE_TASA             VARCHAR2(5 BYTE) CONSTRAINT NN_PR_CREDITOS_CODTIPTASA NOT NULL,
  VARIACION_BASE                  NUMBER(10,4),
  TASA_INTERES                    NUMBER(10,4) CONSTRAINT NN_PR_CREDITOS_TASAINTERES NOT NULL,
  TASA_ORIGINAL                   NUMBER(10,4) CONSTRAINT NN_PR_CREDITOS_TASAORIGINAL NOT NULL,
  ...
  CODIGO_ORIGEN                   NUMBER(2) CONSTRAINT NN_PR_CREDITOS_CODORIGEN NOT NULL,
  ...
  F_APERTURA                      DATE CONSTRAINT NN_PR_CREDITOS_FAPERTURA NOT NULL,
  F_VENCIMIENTO                   DATE,
  F_CANCELACION                   DATE,
  F_ADJUDICACION                  DATE,
  ...
  TIPO_ABONO                      VARCHAR2(1 BYTE) CONSTRAINT NN_PR_CREDITOS_TIPABONO NOT NULL,
  CUENTA_ABONO                    NUMBER(25),
  TIPO_DESEMBOLSO                 VARCHAR2(1 BYTE) CONSTRAINT NN_PR_CREDITOS_TIPDESEMBOLSO NOT NULL,
  CUENTA_DESEM                    NUMBER(25),
  CONTINUA_COBRO_INTERESES        VARCHAR2(1 BYTE) CONSTRAINT NN_PR_CREDITOS_CONTCOBROINT NOT NULL,
  DIA_PAGO                        VARCHAR2(2 BYTE),
  MARCA_REV_TASA                  VARCHAR2(1 BYTE),
  REVALORIZA                      VARCHAR2(1 BYTE) CONSTRAINT NN_PR_CREDITOS_REVALORIZA NOT NULL,
  OBSERVACIONES1                  VARCHAR2(255 BYTE),
  OBSERVACIONES2                  VARCHAR2(255 BYTE),
  ADICIONADO_POR                  VARCHAR2(10 BYTE) CONSTRAINT NN_PR_CREDITOS_ADIPOR NOT NULL,
  FECHA_ADICION                   DATE CONSTRAINT NN_PR_CREDITOS_FECADI NOT NULL,
  MODIFICADO_POR                  VARCHAR2(10 BYTE),
  FECHA_MODIFICACION              DATE,
  CODIGO_SUB_APLICACION           NUMBER(3) CONSTRAINT NN_PR_CREDITOS_CODSUBAPLI NOT NULL,
  ...
  CODIGO_PLAZO                    NUMBER(2) CONSTRAINT NN_PR_CREDITOS_CODPLAZO NOT NULL,
  ...
  FRE_REV_TASA                    VARCHAR2(3 BYTE) DEFAULT 'M' NOT NULL
)
TABLESPACE DATA_EFD
PCTFREE    10
INITRANS   1
...
COMMENT ON COLUMN PR.PR_CREDITOS.FRE_REV_TASA IS 'Campo indicador de Frecuencia de Revisiòn de Tasa, los valores posibles son M - Mensual o T - Trimestral';


CREATE UNIQUE INDEX PR.PK_PR_CREDITOS ON PR.PR_CREDITOS
...
ALTER TABLE PR.PR_CREDITOS ADD (
  CONSTRAINT CK_CREDITOS_CLIENTEPROSPECTO
  CHECK (CLIENTE_PROSPECTO IN ('P','C'))
  ENABLE VALIDATE
,  CONSTRAINT CK_CREDITOS_DESCINTERESESDESEM
  CHECK (DESCUENTA_INTERESES_DESEMBOLSO IN ('S','N'))
  ENABLE VALIDATE
,  CONSTRAINT CK_CREDITOS_INDPRVEHICULO
  CHECK (IND_PR_VEHICULO IN ('S','N'))
  ENABLE VALIDATE
,  CONSTRAINT CK_PR_CREDITOS_CONTCOBROINT
  CHECK ( CONTINUA_COBRO_INTERESES IN ('S','N')             )
  ENABLE VALIDATE
,  CONSTRAINT CK_PR_CREDITOS_ESLINEACREDITO
  CHECK ( ES_LINEA_CREDITO IN ('S','N')             )
  ENABLE VALIDATE
,  CONSTRAINT CK_PR_CREDITOS_MANEJO
  CHECK ( MANEJO IN ('1','2')             )
  ENABLE VALIDATE
,  CONSTRAINT CK_PR_CREDITOS_MODALICOBRO
  CHECK ( MODALIDAD_COBRO IN ('V','H')             )
  ENABLE VALIDATE
,  CONSTRAINT CK_PR_CREDITOS_REVALORIZA
  CHECK ( REVALORIZA IN ('S','N')             )
  ENABLE VALIDATE
,  CONSTRAINT CK_PR_CREDITOS_TIPABONO
  CHECK ( TIPO_ABONO in ('I','A','C','K','O')             )
  ENABLE VALIDATE
,  CONSTRAINT CK_PR_CREDITOS_TIPCALENDARIO
  CHECK ( TIPO_CALENDARIO IN ('1','2','3','4')             )
  ENABLE VALIDATE
,  CONSTRAINT CK_PR_CREDITOS_TIPCUOTA
  CHECK ( TIPO_CUOTA IN ('N','P','V','U','L','M')             )
  ENABLE VALIDATE
,  CONSTRAINT CK_PR_CREDITOS_TIPDESEMBOLSO
  CHECK ( TIPO_DESEMBOLSO IN ('K','C','A')             )
  ENABLE VALIDATE
,  CONSTRAINT CK_PR_CREDITOS_TIPINTERESES
  CHECK ( TIPO_INTERESES IN ('V','A')             )
  ENABLE VALIDATE
,  CONSTRAINT CK_PR_CREDITOS_TIPLINEA
  CHECK ( TIPO_LINEA IN ('R','E')             )
  ENABLE VALIDATE
,  CONSTRAINT CK_PR_CREDITOS_TIPTASA
  CHECK ( TIPO_TASA IN ('F','V')             )
  ENABLE VALIDATE
,  CONSTRAINT CK_PR_CRED_ACUM_INT
  CHECK ( ACUMULA_INTERESES IN ('S','N')             )
  ENABLE VALIDATE
,  CONSTRAINT FK_CREDITOS_DESCCARGOS
  CHECK (DESC_CARGOS IN ('S','N'))
  ENABLE VALIDATE
,  CONSTRAINT FK_CREDITOS_DESCCOMISION
  CHECK (DESC_COMISION IN ('S','N'))
  ENABLE VALIDATE
,  CONSTRAINT FK_CREDITOS_DESCCUOTA
  CHECK (DESC_CUOTA IN ('S','N'))
  ENABLE VALIDATE
,  CONSTRAINT FK_CREDITOS_DESCPOLIZA
  CHECK (DESC_POLIZA IN ('S','N'))
  ENABLE VALIDATE
,  CONSTRAINT FK_CREDITOS_MARCACOBROADM
  CHECK (MARCA_COBRO_ADMINISTRATIVO IN ('S','N'))
  ENABLE VALIDATE
,  CONSTRAINT FK_CREDITOS_TIPOCOMISION
  CHECK (TIPO_COMISION IN ('A','V'))
  ENABLE VALIDATE
,  CONSTRAINT FK_CREDITOS_TIPOMORA
  CHECK (TIPO_MORA IN ('1','2'))
  ENABLE VALIDATE
,  CONSTRAINT FK_CREDITOS_TIPOREVISION
  CHECK (TIPO_REVISION IN ('A','M'))
  ENABLE VALIDATE
,  CONSTRAINT MM_PR_CREDITOS_COMISIONORMAL
  CHECK ( COMISION_NORMAL >=  0             )
  ENABLE VALIDATE
,  CONSTRAINT MM_PR_CREDITOS_CUOTA
  CHECK ( CUOTA >= 0             )
  ENABLE VALIDATE
,  CONSTRAINT MM_PR_CREDITOS_CUOTANTERIOR
  CHECK ( CUOTA_ANTERIOR >= 0             )
  ENABLE VALIDATE
,  CONSTRAINT MM_PR_CREDITOS_GRACIAMORA
  CHECK ( GRACIA_MORA >=  0             )
  ENABLE VALIDATE
,  CONSTRAINT MM_PR_CREDITOS_GRACIAPRINCI
  CHECK ( GRACIA_PRINCIPAL >=  0             )
  ENABLE VALIDATE
,  CONSTRAINT MM_PR_CREDITOS_INTERACUMULADOS
  CHECK ( INTERESES_ACUMULADOS >=  0             )
  ENABLE VALIDATE
,  CONSTRAINT MM_PR_CREDITOS_INTERSUSPENSO
  CHECK ( INTERESES_EN_SUSPENSO >=  0             )
  ENABLE VALIDATE
,  CONSTRAINT MM_PR_CREDITOS_MTOCREDITO
  CHECK ( MONTO_CREDITO >=  0             )
  ENABLE VALIDATE
,  CONSTRAINT MM_PR_CREDITOS_MTODESEMBOLSADO
  CHECK ( MONTO_DESEMBOLSADO >=  0             )
  ENABLE VALIDATE
,  CONSTRAINT MM_PR_CREDITOS_MTOPAGADOINT
  CHECK ( MONTO_PAGADO_INTERESES >=  0             )
  ENABLE VALIDATE
,  CONSTRAINT MM_PR_CREDITOS_MTOPAGADOPRIN
  CHECK ( MONTO_PAGADO_PRINCIPAL >=  0             )
  ENABLE VALIDATE
,  CONSTRAINT MM_PR_CREDITOS_MTOREVALORIZA
  CHECK ( MONTO_REVALORIZACION >=  0             )
  ENABLE VALIDATE
,  CONSTRAINT MM_PR_CREDITOS_PLAZO
  CHECK ( PLAZO >  0             )
  ENABLE VALIDATE
,  CONSTRAINT MM_PR_CREDITOS_TASAINTERES
  CHECK ( TASA_INTERES >=  0             )
  ENABLE VALIDATE
,  CONSTRAINT PR_CREDITO_INCENDIO_PYMES
  CHECK ( Esincendio_Pyme = 'S' Or Esincendio_Pyme Is Null  )
  ENABLE VALIDATE
,  CONSTRAINT PK_PR_CREDITOS
  PRIMARY KEY
  (CODIGO_EMPRESA, NO_CREDITO)
  USING INDEX PR.PK_PR_CREDITOS
  ENABLE VALIDATE);


CREATE INDEX PR.ESTADOPRCREDITOS_IDX ON PR.PR_CREDITOS
...
CREATE INDEX PR.I_PR_CREDITO_CIERRE ON PR.PR_CREDITOS
(CODIGO_EMPRESA, CODIGO_AGENCIA, ESTADO)
LOGGING
TABLESPACE PR_IDX
PCTFREE    10
INITRANS   2
...
CREATE INDEX PR.IDX_PR_CRED_CLI_EST_NOC ON PR.PR_CREDITOS
(CODIGO_CLIENTE, ESTADO, NO_CREDITO)
LOGGING
TABLESPACE PR_IDX
PCTFREE    10
INITRANS   2
...
CREATE INDEX PR.IDX_PR_CREDITOS_CIERRE ON PR.PR_CREDITOS
(CODIGO_EMPRESA, NO_CREDITO, ESTADO, ES_LINEA_CREDITO, MANEJO, 
TIPO_CREDITO)
LOGGING
TABLESPACE IND_EFD
PCTFREE    10
...
CREATE INDEX PR.IDX_PR_CREDITOS_COD_EJEC ON PR.PR_CREDITOS
(CODIGO_EMPRESA, CODIGO_EJECUTIVO)
LOGGING
TABLESPACE PR_DAT
PCTFREE    10
INITRANS   2
...
CREATE INDEX PR.IDX_PR_CREDITOS1 ON PR.PR_CREDITOS
...
CREATE INDEX PR.IDX_PR_CREDITOS2 ON PR.PR_CREDITOS
(CODIGO_EMPRESA, NO_CREDITO_ORIGEN)
LOGGING
TABLESPACE IND_EFD
PCTFREE    10
INITRANS   2
...
CREATE INDEX PR.IDX_PRCREDITOS_IDSISTEMAEXT ON PR.PR_CREDITOS
(CODIGO_EMPRESA, ID_SISTEMA_EXTERNO)
LOGGING
TABLESPACE PR_DAT
PCTFREE    10
INITRANS   2
...
CREATE INDEX PR.PR_CREDITOS_FK1 ON PR.PR_CREDITOS
...
CREATE INDEX PR.PR_CREDITOS_FK10 ON PR.PR_CREDITOS
...
CREATE INDEX PR.PR_CREDITOS_FK11 ON PR.PR_CREDITOS
(CODIGO_PLAZO)
LOGGING
TABLESPACE PR_IDX
PCTFREE    10
...
CREATE INDEX PR.PR_CREDITOS_FK12 ON PR.PR_CREDITOS
...
CREATE INDEX PR.PR_CREDITOS_FK13 ON PR.PR_CREDITOS
...
CREATE INDEX PR.PR_CREDITOS_FK2 ON PR.PR_CREDITOS
...
CREATE INDEX PR.PR_CREDITOS_FK3 ON PR.PR_CREDITOS
(CODIGO_ORIGEN)
LOGGING
TABLESPACE PR_IDX
PCTFREE    10
...
CREATE INDEX PR.PR_CREDITOS_FK4 ON PR.PR_CREDITOS
(SEGREGACION_RD)
LOGGING
TABLESPACE PR_IDX
PCTFREE    10
...
CREATE INDEX PR.PR_CREDITOS_FK5 ON PR.PR_CREDITOS
...
CREATE INDEX PR.PR_CREDITOS_FK6 ON PR.PR_CREDITOS
(COD_NOTARIO)
LOGGING
TABLESPACE PR_IDX
PCTFREE    10
...
CREATE INDEX PR.PR_CREDITOS_FK7 ON PR.PR_CREDITOS
(ESTADO)
LOGGING
TABLESPACE PR_IDX
PCTFREE    10
...
CREATE INDEX PR.PR_CREDITOS_FK8 ON PR.PR_CREDITOS
...
CREATE INDEX PR.PR_CREDITOS_FK9 ON PR.PR_CREDITOS
(CODIGO_REFERENTE)
LOGGING
TABLESPACE PR_IDX
PCTFREE    10
...
DROP SEQUENCE PR.PR_CREDITOS_AUDIT_SQ;

CREATE SEQUENCE PR.PR_CREDITOS_AUDIT_SQ
  START WITH 10639281
...
CREATE OR REPLACE TRIGGER PR.PR_CREDITOS_TRG01
    /* ********************************************************************************************
...
----P_DEPURA('trg Linea: '||$$plsql_line);
  ...
  IF    NVL (:NEW.estado_aprobacion, '~') = 'Z' AND :OLD.ESTADO = 'R'
           OR :OLD.ESTADO = 'A' AND :NEW.ESTADO = 'D' THEN    --malmanzar 01-01-2024 Begin

      BEGIN
            pr_pkg_notificacion.p_notificacion_sms (
                pcodigo_empresa   => :new.codigo_empresa,
        ...
        EXCEPTION
            ...
            THEN
                NULL;
        END;
  END IF;    -- malmanzar 01-01-2024 End
    ...
    BEGIN
        IF    NVL (:NEW.estado_aprobacion, '~') = 'Z' AND :OLD.ESTADO = 'R'
           ...
           OR     NVL (:NEW.estado_aprobacion, '~') = 'Y'
              AND NVL (:OLD.estado_aprobacion, '~') = 'Z'
        THEN
            IF     NVL (:NEW.estado_aprobacion, '~') = 'Y'
               AND NVL (:OLD.estado_aprobacion, '~') = 'Z'
            THEN
            ...
            pr_plan_proyeccion.p_inserta_apr (
                pCodigo_Empresa   => :NEW.CODIGO_EMPRESA,
                pNo_credito       => :NEW.NO_CREDITO,
                pCodigo_Cliente   => :NEW.CODIGO_CLIENTE,
    ...
    END IF;
        ...
        --anytorres Req 51308, para asegurar que el si el TIPO_REESTRUCTURACION es RP no se cambie el estado.
    IF NVL (:NEW.TIPO_REESTRUCTURACION, 'X') <> 'RP'
    THEN
        IF     (   (    :NEW.TIPO_REESTRUCTURACION IS NOT NULL
                    AND :NEW.TIPO_REESTRUCTURACION <> 'RP')
                OR :NEW.F_RESTRUCTURACION IS NOT NULL)
           AND :NEW.ESTADO IN ('D', 'V', 'M')
        THEN
            :NEW.ESTADO := 'E';
        END IF;
    END IF;
...
CREATE OR REPLACE TRIGGER "PR"."TRG_AD_REG_CREDITOS" 
AFTER DELETE
...
CREATE OR REPLACE TRIGGER "PR"."TRG_AUD_PR_CREDITOS" 
...
CREATE OR REPLACE TRIGGER "PR"."TRG_AUDITA_PR_CREDITOS" 
/******************************************************************************
...
CREATE OR REPLACE TRIGGER "PR"."TRG_BUI_REG_CREDITOS" 
...
CREATE OR REPLACE TRIGGER "PR"."TRG_CREDITO_REPRESTAMO" 
...
begin
    begin
        select case :new.estado
                   when 'R' then case :new.estado_aprobacion when 'P' then 'CRS' when 'A' then 'CRV' when 'H' then 'CRH' when 'Z' then 'CRA' end
                   when 'A' then case :new.estado_aprobacion when 'Y' then 'CRY' end
                   when 'D' then 'CRD'
                   when 'N' then 'CRN'
                   when 'C' then 'AN'
               end,
    ...
    if vestado = 'AN'
       and vidreprestamo is not null
       and vestado <> vestadorepre then
        pr_pkg_represtamos.p_generar_bitacora(vidreprestamo,
                                              null,
                                              vestado,
                                              null,
                                              'Credito anterior cancelado',
                                              user);
    end if;
...
CREATE OR REPLACE TRIGGER IA.TRG_CREDITO_REPRESTAMO
   BEFORE UPDATE OF ESTADO,ESTADO_APROBACION
   ON PR.PR_CREDITOS
   REFERENCING NEW AS New OLD AS Old
   FOR EACH ROW
...
CREATE OR REPLACE TRIGGER "PR"."TRG_PR_GENERA_REPORTES" 
   BEFORE INSERT 
   ON PR.PR_CREDITOS
   REFERENCING NEW AS New OLD AS Old
   FOR EACH ROW
...
CREATE OR REPLACE TRIGGER "PR"."TRG_PR_VALIDA_TASA" 
   BEFORE INSERT 
   ON PR.PR_CREDITOS
   REFERENCING NEW AS New OLD AS Old
   FOR EACH ROW
...
CREATE OR REPLACE TRIGGER "PR"."TRG_PRODUCTOS_CLTE" 
AFTER INSERT
ON PR.PR_CREDITOS REFERENCING NEW AS New OLD AS Old
FOR EACH ROW
DISABLE
...
CREATE OR REPLACE PUBLIC SYNONYM PR_CREDITOS FOR PR.PR_CREDITOS;


ALTER TABLE PR.PR_CREDITOS ADD (
  CONSTRAINT FK_CLIENTES_PR_CREDITOS 
  FOREIGN KEY (CODIGO_CLIENTE, CODIGO_EMPRESA) 
  REFERENCES PA.CLIENTES_B2000 (CODIGO_CLIENTE, CODIGO_EMPRESA)
  ENABLE NOVALIDATE
,  CONSTRAINT FK_CREDITOS_ESTADO 
  FOREIGN KEY (ESTADO) 
  REFERENCES PR.PR_ESTADOS_CREDITO (CODIGO_ESTADO)
  ENABLE VALIDATE
,  CONSTRAINT FK_CREDITOS_NIVELAPROBACION 
  FOREIGN KEY (CODIGO_NIVEL_APROBACION) 
  REFERENCES PR.PR_NIVELES_APROBACION (CODIGO_NIVEL_APROBACION)
  ENABLE VALIDATE
,  CONSTRAINT FK_CREDITOS_NOTARIO 
  FOREIGN KEY (COD_NOTARIO) 
  REFERENCES PA.PERSONAS (COD_PERSONA)
  ENABLE VALIDATE
,  CONSTRAINT FK_CREDITOS_PERIODICIDAD 
  FOREIGN KEY (CODIGO_PERIODO_CUOTA) 
  REFERENCES PR.PR_PERIODICIDAD (CODIGO_PERIODO)
  ENABLE VALIDATE
,  CONSTRAINT FK_CREDITOS_PERIOD_INT 
  FOREIGN KEY (CODIGO_PERIODO_INTERESES) 
  REFERENCES PR.PR_PERIODICIDAD (CODIGO_PERIODO)
  ENABLE VALIDATE
,  CONSTRAINT FK_CREDITOS_PERIOD_NORMAL 
  FOREIGN KEY (PERIODO_COMISION_NORMAL) 
  REFERENCES PR.PR_PERIODICIDAD (CODIGO_PERIODO)
  ENABLE VALIDATE
,  CONSTRAINT FK_CREDITOS_PLANINVERSION 
  FOREIGN KEY (CODIGO_EMPRESA, PLAN_INVERSION) 
  REFERENCES PR.PR_PLAN_INVERSION (CODIGO_EMPRESA, PLAN_INVERSION)
  ENABLE VALIDATE
,  CONSTRAINT FK_CREDITOS_PRORIGENFONDOS 
  FOREIGN KEY (CODIGO_ORIGEN) 
  REFERENCES PR.PR_ORIGEN_FONDOS (CODIGO_ORIGEN)
  ENABLE VALIDATE
,  CONSTRAINT FK_CREDITOS_REFERENTES 
  FOREIGN KEY (CODIGO_REFERENTE) 
  REFERENCES PR.PR_REFERENTES (CODIGO_REFERENTE)
  ENABLE VALIDATE
,  CONSTRAINT FK_CREDITOS_TIPOCREDITO 
  FOREIGN KEY (CODIGO_EMPRESA, TIPO_CREDITO) 
  REFERENCES PR.PR_TIPO_CREDITO (CODIGO_EMPRESA, TIPO_CREDITO)
  ENABLE VALIDATE
,  CONSTRAINT FK_CREDITOS_TIPOSPLAZOS 
  FOREIGN KEY (CODIGO_PLAZO) 
  REFERENCES PR.PR_TIPOS_PLAZOS (CODIGO_PLAZO)
  ENABLE VALIDATE
,  CONSTRAINT FK_PRCREDITOS_PAACTECONCIIU 
  FOREIGN KEY (SEGREGACION_RD) 
  REFERENCES PA.ACTIVIDADES_ECONOMICAS_BC_CIIU (SEGREGACION_RD)
  ENABLE VALIDATE
,  CONSTRAINT FK_PR_CREDITOS_PR_GRPMC 
...
GRANT DELETE, INSERT, SELECT, UPDATE ON PR.PR_CREDITOS TO BCB;

GRANT ALTER, DELETE, INSERT, SELECT, UPDATE ON PR.PR_CREDITOS TO BCG;

GRANT SELECT ON PR.PR_CREDITOS TO BCV;

GRANT ALTER, DELETE, INSERT, SELECT, UPDATE ON PR.PR_CREDITOS TO BDI;

GRANT SELECT ON PR.PR_CREDITOS TO BFERNANDEZ;

GRANT SELECT ON PR.PR_CREDITOS TO BPA;

GRANT ALTER, DELETE, INSERT, SELECT, UPDATE ON PR.PR_CREDITOS TO BPR;
...
GRANT ALTER, DELETE, INSERT, SELECT, UPDATE ON PR.PR_CREDITOS TO CONGEN;
...
GRANT ALTER, DELETE, INDEX, INSERT, REFERENCES, SELECT, UPDATE ON PR.PR_CREDITOS TO PA WITH GRANT OPTION;

GRANT SELECT ON PR.PR_CREDITOS TO PS;

GRANT DELETE, INSERT, REFERENCES, SELECT, UPDATE ON PR.PR_CREDITOS TO PUBLIC;

GRANT ALTER, DELETE, INDEX, INSERT, REFERENCES, SELECT, UPDATE, ON COMMIT REFRESH, QUERY REWRITE, DEBUG, FLASHBACK ON PR.PR_CREDITOS TO RH;

GRANT SELECT ON PR.PR_CREDITOS TO RT WITH GRANT OPTION;

GRANT REFERENCES, SELECT ON PR.PR_CREDITOS TO SB;
...
GRANT SELECT ON PR.PR_CREDITOS TO USR_BGP_DEPONENTE;

GRANT SELECT ON PR.PR_CREDITOS TO USR_BGP_SEGURO;

GRANT SELECT ON PR.PR_CREDITOS TO USR_DEBUG;

GRANT SELECT ON PR.PR_CREDITOS TO USR_DOC_FILEFLOW;

GRANT SELECT ON PR.PR_CREDITOS TO USR_PORTACREDIT_MS;

GRANT SELECT ON PR.PR_CREDITOS TO USR_REPRESTAMO;
