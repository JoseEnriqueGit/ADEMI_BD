...
> Registro cronolÃ³gico de cambios desplegados en el entorno de QA.
...
- **Notas**: Correccion de conversion implicita en JOIN a PERSONAS_FISICAS, adicion de CODIGO_EMPRESA en JOIN a PR_SOLICITUD_REPRESTAMO, y COMMIT fuera del loop. Cost de 18,293 a 15. Ver `historias/optimizaciones/probados_no_promovidos/OPT-001_SQL227_WORLD_COMPLIANCE/`
