...
-- Estado: FINAL con vigencia evaluada SOLO por ESTADO en los filtros por card
-- Fecha: 2026-05-08
-- Cambio respecto a 2026-05-01: vigencia evaluada solo por ESTADO
-- y rama nueva para click en la card "Total Certificados Abiertos".
...
WHERE
    ...
    AND (
        ...
        OR (
            :P135_FILTRO_CARD = 'Total Certificados Abiertos'
        )
        OR (
