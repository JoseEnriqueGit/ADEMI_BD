...
| Decision final | Incrementos A y B aceptados en QA02. Pendientes Incremento C y capa DIAGNOSTICA. Restaurar `LOTE_DE_CARAGA_REPRESTAMO=130000` (quedo en 1300 por la prueba). No promover sin nueva aprobacion. |
