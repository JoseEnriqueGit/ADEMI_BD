-- =====================================================================
-- Capa DIAGNOSTICA - Precalifica_Represtamo_fiadores
-- Entorno: QA02. Ejecutar como script (F5) en Toad DESPUES del job.
-- GENERADO desde trackers_precalifica_post_cursor_fast/04_PRECALIFICA_REPRESTAMO_FIADORES_CURSOR_QA02.sql:
...
PROMPT Filas DIAGNOSTICA insertadas para Precalifica_Represtamo_fiadores (ultima ejecucion)

SELECT COUNT(*) filas_diagnostica
  FROM PR.PR_JOB_PRECALIFICA_FILTRO_TRACK f
 WHERE f.tipo_medicion = 'DIAGNOSTICA'
   AND f.flujo = 'Precalifica_Represtamo_fiadores'
