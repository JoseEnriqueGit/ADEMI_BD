-- =====================================================================
-- Capa DIAGNOSTICA - Precalifica_Repre_Cancelado
-- Entorno: QA02. Ejecutar cada sentencia con F9 DESPUES del job.
-- GENERADO desde trackers_precalifica_post_cursor_fast/02_PRECALIFICA_REPRE_CANCELADO_CURSOR_QA02.sql:
...
-- PASO 3 (F9): confirmar solo si el conteo anterior devuelve 22.
COMMIT;
