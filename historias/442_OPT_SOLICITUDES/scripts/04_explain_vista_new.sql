-------------------------------------------------------------------------------
-- EXPLAIN PLAN: Vista PR_V_ENVIO_REPRESTAMOS (DESPUES - version optimizada)
-- Ejecutar en DESARROLLO
-------------------------------------------------------------------------------

EXPLAIN PLAN SET STATEMENT_ID = 'VISTA_NEW' FOR
WITH VALOR_PARAM AS (
...
-- Ver resultados
SELECT * FROM TABLE(DBMS_XPLAN.DISPLAY(NULL, 'VISTA_NEW', 'ALL'));
