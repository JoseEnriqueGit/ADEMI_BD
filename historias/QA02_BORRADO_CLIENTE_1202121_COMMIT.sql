...
-- Uso sugerido: ejecutar completo en Toad para borrar definitivamente tras validar el script seguro.
-- Seguridad: version final con COMMIT. Ejecutar solo despues de una corrida con conteos finales en cero.
...
PROMPT 5) Seguridad
PROMPT ============================================================================
PROMPT Esta version confirma el borrado con COMMIT.
