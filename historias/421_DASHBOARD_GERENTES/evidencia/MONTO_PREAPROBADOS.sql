https://g.co/gemini/share/996dcf9ecde9

De acuerdo a este paquete de oracle como obtengo la cantidad de solicitudes y monto preaprobado filtrando por empleados y código de la agencia a la que pertenece, es este caso el el empleado es gerente de una sucursal y quiere saber como obtener el cantidad de solicitudes y monto preaprobado, te dejo el paquete para que tengas un mejor contexto de la base de datos y de como funciona el flujo o ciclo de vida de un represtamos.

Y tambien te dejo un ejemplo de como obtengo los dato de ese Gerentes o Directores de Negocios:
  SELECT * FROM PR_SOLICITUD_REPRESTAMO S  

  JOIN PA.EMPLEADOS P ON P.EMAIL1 LIKE '%NHENRIQUEZ%'

  WHERE S.CODIGO_AGENCIA = P.COD_AGENCIA
