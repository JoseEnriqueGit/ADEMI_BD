-- =====================================================================
-- OPT-020 - Crear solo PR.V_REPRE_CREDITOS_GAR
--
-- Usar si 01_CREATE_VIEWS.sql no muestra claramente el error de creacion.
-- =====================================================================

PROMPT ================================================================
PROMPT OPT-020 Q01A - Crear vista PR.V_REPRE_CREDITOS_GAR
PROMPT ================================================================
...
PROMPT ================================================================
PROMPT OPT-020 Q01A - Verificar vista creada
PROMPT ================================================================

SELECT owner, object_name, object_type, status
  FROM all_objects
 WHERE owner = 'PR'
   AND object_name = 'V_REPRE_CREDITOS_GAR';
