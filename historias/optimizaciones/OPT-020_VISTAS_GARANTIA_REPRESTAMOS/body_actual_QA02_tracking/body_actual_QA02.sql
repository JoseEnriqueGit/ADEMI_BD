    ...
    BEGIN
      ...
      -- de lo contrario ejecuto un Return, para que el Package CDG.P_CARGA_PRESTAMOS termine su Ejecuci¿n.  
       ...
       LOOP
          ...
          FETCH CREDITOS_PROCESAR BULK COLLECT INTO VCREDITOS_PROCESAR LIMIT 6000;
        ...
        CURSOR CUR_REPRESTAMO IS
         ...
         END track_error;
                   ...
                   BEGIN
                      ...
                      track_inicio(12, 'LOOP_FINAL_VALIDACIONES_BITACORA');
                      OPEN CUR_REPRESTAMO;
                ...
                track_inicio(13, 'ACTUALIZA_PARAMETRO_EJECUCIONES');
