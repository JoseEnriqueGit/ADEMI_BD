...
- `body_ANTES_BASE_OPT015.sql` — body original para revertir
- `body_DESPUES_ACUMULADO.sql` — body con cambios OPT-015
...
| `historias/optimizaciones/scripts_medicion/05_MEDIR_JOB_REPRESTAMOS_ACUMULADO.sql` | Script medicion |
