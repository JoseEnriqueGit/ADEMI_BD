-- OPT-007 BEFORE: PVALIDA_XCORE con COMMIT dentro del FOR LOOP
-- Fuente: PR.PR_PKG_REPRESTAMOS body.sql (QA) antes del commit e13ee50
-- El COMMIT en linea ~3734 se ejecuta en cada iteracion del cursor
...
PROCEDURE PVALIDA_XCORE IS --SROBLES
        ...
        DBMS_OUTPUT.PUT_LINE ( 'Entro en Validar XCore');
            ...
            FOR cliente IN c_clientes LOOP
                ...
                END IF;
                COMMIT;  -- <<< PROBLEMA: COMMIT dentro del loop
            END LOOP;
