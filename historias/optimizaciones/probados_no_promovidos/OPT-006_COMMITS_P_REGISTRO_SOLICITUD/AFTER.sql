-- ============================================================
-- OPT-006 AFTER: COMMIT movido fuera del FOR loop
-- Paquete: PR_PKG_REPRESTAMOS (body.sql, QA)
-- Procedures: P_REGISTRO_SOLICITUD (~linea 8007)
--             P_Carga_Precalifica_Manual (~linea 8279)
-- ============================================================
-- Cambio: Se mueve el COMMIT despues del END LOOP para que
-- se ejecute una sola vez al final del procesamiento completo,
-- reduciendo el overhead de redo log writes.
-- ============================================================
...
PROCEDURE P_REGISTRO_SOLICITUD IS
     ...
     BEGIN
               ...
               END LOOP ;
               COMMIT;  -- <-- COMMIT una sola vez despues del loop
...
-- (seccion relevante del FOR loop con COMMIT externo)
-- ==============================
