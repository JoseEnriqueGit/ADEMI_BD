...
| OPT | Cambio | Impacto |
|-----|--------|---------|
| OPT-004 | Loop row-by-row â†’ 2 UPDATEs set-based en Actualiza_Precalificacion | Elimina N context switches |
| OPT-010 | F_TIENE_GARANTIA() â†’ NOT EXISTS inline en 3 cursores CREDITOS_PROCESAR | Elimina context switch por fila |

## Archivos necesarios

| Archivo | Contenido |
|---------|-----------|
| `body copy.sql` | Paquete actual de la BD (SIN optimizaciones) â€” para medir ANTES |
| `body_copy_OPT004_010.sql` | Paquete con OPT-004 y OPT-010 aplicadas â€” para medir DESPUES |
| `04_MEDIR_JOB_CANCELADO.sql` | Script de medicion |

Ambos archivos estan en `historias/optimizaciones/soporte/scripts_medicion/`
...
### Paso 1 â€” Verificar estado actual
...
### Paso 2 â€” Medir ANTES (codigo original)
...
### Paso 3 â€” Compilar paquete con OPT-004 + OPT-010
...
### Paso 4 â€” Medir DESPUES (con OPT-004 + OPT-010)
Abrir: `scripts_medicion/04_MEDIR_JOB_CANCELADO.sql`
...
### Paso 5 â€” Comparar y documentar
...
### Paso 6 â€” Decidir si mantener o revertir
...
- Si dice "ORA-04068: existing state of packages has been discarded": es normal despues de recompilar â€” ejecutar de nuevo
