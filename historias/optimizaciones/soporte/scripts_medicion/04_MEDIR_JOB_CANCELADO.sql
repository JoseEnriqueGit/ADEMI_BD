-- =====================================================================
-- Script de medicion: JOB_CARGA_PRECALIFICA_RD (Job 1)
-- Mide: P_Carga_Precalifica_Cancelado
...
BEGIN
    ...
    v_mensaje := NULL;
    PR.PR_PKG_REPRESTAMOS.P_CARGA_PRECALIFICA_CANCELADO(v_mensaje);
    COMMIT;
    ...
    DBMS_OUTPUT.PUT_LINE('=== MEDICION JOB_CARGA_PRECALIFICA_RD (Job 1) ===');
