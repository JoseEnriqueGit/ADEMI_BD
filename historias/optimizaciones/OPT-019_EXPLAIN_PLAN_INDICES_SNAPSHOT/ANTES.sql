...
-- Uso: ejecutar antes de crear indices candidatos.
-- Nota: ajustar ID_REPRESTAMO con un ID real de QA para planes mas fieles.
...
DELETE FROM PLAN_TABLE WHERE STATEMENT_ID LIKE 'OPT019_%_BEFORE';

PROMPT ============================================================
PROMPT Q00 - Indices existentes relevantes
PROMPT ============================================================
...
EXPLAIN PLAN SET STATEMENT_ID = 'OPT019_Q02A_TRACE_BEFORE' FOR
...
EXPLAIN PLAN SET STATEMENT_ID = 'OPT019_Q02B_RE_IDS_BEFORE' FOR
SELECT id_represtamo
  FROM PR.PR_REPRESTAMOS
 WHERE estado = '&ESTADO_RE';

SELECT * FROM TABLE(DBMS_XPLAN.DISPLAY('PLAN_TABLE',
                                       'OPT019_Q02B_RE_IDS_BEFORE',
                                       'TYPICAL +PREDICATE +ALIAS'));
...
EXPLAIN PLAN SET STATEMENT_ID = 'OPT019_Q03_ESTADO_BEFORE' FOR
...
EXPLAIN PLAN SET STATEMENT_ID = 'OPT019_Q04_SEL_EST_BEFORE' FOR
SELECT ROWID
  FROM PR.PR_REPRESTAMOS
 WHERE codigo_empresa = &CODIGO_EMPRESA
...
EXPLAIN PLAN SET STATEMENT_ID = 'OPT019_Q05_SEL_FECHA_BEFORE' FOR
...
EXPLAIN PLAN SET STATEMENT_ID = 'OPT019_Q06_BIT_SEQ_BEFORE' FOR
SELECT COUNT(1) + 1
...
EXPLAIN PLAN SET STATEMENT_ID = 'OPT019_Q07_BIT_NR_BEFORE' FOR
