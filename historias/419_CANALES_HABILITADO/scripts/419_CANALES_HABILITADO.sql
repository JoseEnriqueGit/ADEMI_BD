...
Actuando como un administrador de base de datos de oracle, requiero que me indiques el ciclo de vida de vida o el flujo desde el momento que subo un archivo con información que tiene la imagen que te proporcione, tengo claro cual es la funcion que carga los datos en paquete, pero de oracle apex se carga un archivo con el contenido de la imagen y se ejecuta un proceso para determinar si esas solicitudes de préstamos o represtamos de esos cliente cumplen con los requisitos para obtenerlos.



Se me asignó una historia que tiene estos criterios:



Yo como negocios requiero que el envío de los SMS se pueda detener por separado en los diferentes módulos Représtamo Digital, Carga Dirigida y Campañas Especiales.

Criterios de aceptación:

Que cada módulo (Représtamo Digital, Carga Dirigida y Campañas Especiales) debe tener su propia opción de "Canales Habilitados" para el envío de SMS.

El envío de SMS debe poder detenerse de forma independiente en cada módulo sin afectar a los otros.

Si el envío de SMS está deshabilitado en un módulo, los mensajes no deben enviarse, pero los otros módulos deben seguir funcionando normalmente si están habilitados.

Crea parámetros para poder inhabilitar y habilitar el envió de los mismos.



y al parecer solo tengo que cambiar esta línea en el paquete de represtamos
...
ahora lo modifique para que sea asi:
...
esto es el procedure P_Registra_Solicitud_Campana



y luego cambie el otro procedure P_Registra_Solicitud_Dirigida
