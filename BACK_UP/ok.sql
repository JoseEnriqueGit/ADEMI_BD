Bien ahora entiendo mejor el por que usar el RE, vamos aplicar esa lógica a en este paquete de represtamo de desarrollo para implementar esa lógica y luego de que la analizes, dame el paso a paso implementarla:
